...
<svg width="25" viewbox="0 0 25 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
  ...
  <ul class="menu-inner py-1">
    ...
    <li class="menu-item">
      ...
      <i class='menu-icon bx bx-cart-alt tf-icons'></i>
        <div data-i18n="Dashboards">ຂາຍສິນຄ້າ POS</div>
      </router-link>
    </li>

    <li class="menu-item">
      <router-link to="/transection" class="menu-link ">
      <i class='menu-icon bx bx-bar-chart-alt tf-icons'></i>
    ...
    <li class="menu-item">
      ...
      <i class='menu-icon bx bxs-report tf-icons'></i>
